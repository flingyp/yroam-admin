  ...
  <div class="login-page-container">
    <main class="login-form-container">
      ...
      <div class="form-container-right">
        ...
        <n-form class="form-container" ref="formRef" :label-width="80" :model="LoginFormData" :rules="LoginRules"
          :size="FormSize">
          <n-form-item path="username">
            <n-input v-model:value="LoginFormData.username" placeholder="请输入个人账号："></n-input>
          </n-form-item>
          <n-form-item path="password">
            <n-input v-model:value="LoginFormData.password" placeholder="请输入密码：" type="password"
