<template>
    <div>
        <DataTable v-model:IsLoading="IsShowLoading" :TableColumns="Columns" :TableData="Data" :TableMaxHeight="620"
            :ScrollX="2000" :IsPagination="TablePagination"></DataTable>
        ...
        <NModal v-model:show="ModifyInfoModal">
            <NCard style="width: 700px" title="修改用户" :bordered="false" size="huge" role="dialog" aria-modal="true">
                <NForm class="form-container" ref="formRef" :model="ModifyModelData" label-placement="left"
                    ...
                    <NFormItem label="年龄" path="inputValue">
                        <NInputNumber v-model:value="ModifyModelData.age" placeholder="please select your age">
                        </NInputNumber>
                    </NFormItem>
